...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        # Этот элемент не виден на странице, но используется для загрузки файла через Playwright
    ...
    # Playwright использует метод set_input_files(), чтобы загрузить указанный файл в найденный input
    def upload_preview_image(self, file: str):
        self.upload_input.set_file_input(file)
